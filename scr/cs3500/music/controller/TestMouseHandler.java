...
public class TestMouseHandler {
  ...
  public void testMouseListener() {
    ...
    ml.mouseClicked(new MouseEvent(new JPanel(), 0, 0, 0, 55, 55, 1, false, MouseEvent.BUTTON1));
    assertEquals(str.toString(), "Click: B1 at 55, 55\n");
    ml.mousePressed(new MouseEvent(new JPanel(), 0, 0, 0, 55, 55, 1, false, MouseEvent.BUTTON1));
    assertEquals(str.toString(), "Click: B1 at 55, 55\n" +
        "Press: B1 at 55, 55\n");
    ml.mouseReleased(new MouseEvent(new JPanel(), 0, 0, 0, 5, 5, 1, false, MouseEvent.BUTTON2));
    assertEquals(str.toString(), "Click: B1 at 55, 55\n" +
        "Press: B1 at 55, 55\n" +
        "Release: B2 at 5, 5\n");
    ml.mouseReleased(new MouseEvent(new JPanel(), 0, 0, 0, 5, 5, 1, false, MouseEvent.BUTTON3));
    assertEquals(str.toString(), "Click: B1 at 55, 55\n" +
        "Press: B1 at 55, 55\n" +
        "Release: B2 at 5, 5\n");
    ml.mouseReleased(new MouseEvent(new JPanel(), 0, 0, 0, 5, 35, 1, false, MouseEvent.BUTTON1));
    ml.mouseClicked(new MouseEvent(new JPanel(), 0, 0, 0, 15, 5, 1, false, MouseEvent.BUTTON3));
    ml.mousePressed(new MouseEvent(new JPanel(), 0, 0, 0, 3, 25, 1, false, MouseEvent.BUTTON3));
    assertEquals(str.toString(), "Click: B1 at 55, 55\n" +
        "Press: B1 at 55, 55\n" +
        "Release: B2 at 5, 5\n" +
        "Release: B1 at 5, 35\n" +
